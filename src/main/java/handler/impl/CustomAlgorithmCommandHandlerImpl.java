...
import operation.CustomMultiplier;

public class CustomAlgorithmCommandHandlerImpl implements CommandHandler {
    ...
    private void promptUser() {
        System.out.println("Custom algorithm");
    ...
    public BigInteger calculate(String firstNumber, String secondNumber) {
        ...
        BigInteger result = CustomMultiplier.multiply(a, b);
        System.out.println("Using Custom algorithm");
